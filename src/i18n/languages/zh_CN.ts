...
export const zh_CN: Translation = {
	...
	// 足迹页面
	[Key.places]: "足迹",
	[Key.placesTitle]: "去过的地方",
	[Key.placesSubtitle]: "足迹地图与旅行记录",
	[Key.placesStatLocations]: "地点",
	[Key.placesStatVisits]: "到访次数",
	[Key.placesStatThisYear]: "今年出行",
	[Key.placesMap]: "去过的地方",
	[Key.placesList]: "地点列表",
	[Key.placesNoData]: "暂无地点记录",
	[Key.placesNoDataHint]: "在 src/content/places/ 下新建 md 即可添加",
	[Key.placesUnknownProvince]: "未知省份",
	[Key.placesVisitLabel]: "到访",
	[Key.placesTimes]: "次",
	[Key.placesMapCredit]: "地图由 高德地图 提供",
	[Key.placesMapLoadFailed]: "地图加载失败，请检查高德 Key",
	[Key.placesNotVisited]: "未到访",
	[Key.placesUnmarked]: "未标记",
	[Key.placesMorePrefix]: "...等",
	[Key.placesMoreSuffix]: "处",
	[Key.placesLatestTrip]: "最近出行",
	[Key.placesVisitedProvinces]: "已到访省份",
	[Key.placesMapHint]: "可拖拽缩放地图",
	[Key.placesFilterAll]: "全部",
	[Key.placesFilterAllFootprints]: "全部足迹",
	[Key.placesSourceTimeline]: "时间线",
	[Key.placesMapOwnerLocation]: "博主位置",
	[Key.placesMapVisitorLocation]: "访问者位置",
	[Key.placesAreaHighlight]: "区域高亮",
	[Key.placesClusterDisplay]: "集群显示",
	[Key.placesNeedAmapKey]:
		"请在 siteConfig.placesMap 中配置高德 amapKey 与 amapSecurityJsCode",
	[Key.placesStatLocationsUnit]: "地点",
	[Key.placesStatVisitsUnit]: "到访次数",
	[Key.placesStatThisYearUnit]: "今年出行",
	[Key.placesRefresh]: "刷新视野",
