...
export const zh_TW: Translation = {
	...
	[Key.albumsPhotoCount]: "照片",
	[Key.albumsPhotosCount]: "照片",
	...
	// 足跡頁面
	[Key.places]: "足跡",
	[Key.placesTitle]: "去過的地方",
	[Key.placesSubtitle]: "足跡地圖與旅行記錄",
	[Key.placesStatLocations]: "地點",
	[Key.placesStatVisits]: "到訪次數",
	[Key.placesStatThisYear]: "今年出行",
	[Key.placesMap]: "去過的地方",
	[Key.placesList]: "地點列表",
	[Key.placesNoData]: "暫無地點記錄",
	[Key.placesNoDataHint]: "在 src/content/places/ 下新增 md 即可加入",
	[Key.placesUnknownProvince]: "未知省份",
	[Key.placesVisitLabel]: "到訪",
	[Key.placesTimes]: "次",
	[Key.placesMapCredit]: "地圖由 高德地圖 提供",
	[Key.placesMapLoadFailed]: "地圖載入失敗，請檢查高德 Key",
	[Key.placesNotVisited]: "未到訪",
	[Key.placesUnmarked]: "未標記",
	[Key.placesMorePrefix]: "...等",
	[Key.placesMoreSuffix]: "處",
	[Key.placesLatestTrip]: "最近出行",
	[Key.placesVisitedProvinces]: "已到訪省份",
	[Key.placesMapHint]: "可拖曳縮放地圖",
	[Key.placesFilterAll]: "全部",
	[Key.placesFilterAllFootprints]: "全部足跡",
	[Key.placesSourceTimeline]: "時間線",
	[Key.placesMapOwnerLocation]: "部落客位置",
	[Key.placesMapVisitorLocation]: "訪客位置",
	[Key.placesAreaHighlight]: "區域高亮",
	[Key.placesClusterDisplay]: "集群顯示",
	[Key.placesNeedAmapKey]:
		"請在 siteConfig.placesMap 中設定高德 amapKey 與 amapSecurityJsCode",
	[Key.placesStatLocationsUnit]: "地點",
	[Key.placesStatVisitsUnit]: "到訪次數",
	[Key.placesStatThisYearUnit]: "今年出行",
	[Key.placesRefresh]: "重新整理視野",
	[Key.placesFullscreen]: "全螢幕",
