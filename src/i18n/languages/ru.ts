...
export const ru: Translation = {
	...
	// Страница мест
	[Key.places]: "Места",
	[Key.placesTitle]: "Где я был",
	[Key.placesSubtitle]: "Карта перемещений и журнал путешествий",
	[Key.placesStatLocations]: "Места",
	[Key.placesStatVisits]: "Визитов",
	[Key.placesStatThisYear]: "В этом году",
	[Key.placesMap]: "Где я был",
	[Key.placesList]: "Список мест",
	[Key.placesNoData]: "Пока нет записей о местах",
	[Key.placesNoDataHint]: "Добавьте новый md-файл в src/content/places/",
	[Key.placesUnknownProvince]: "Неизвестная провинция",
	[Key.placesVisitLabel]: "Посещено",
	[Key.placesTimes]: "раз",
	[Key.placesMapCredit]: "Карта предоставлена Amap",
	[Key.placesMapLoadFailed]: "Не удалось загрузить карту. Проверьте ключ Amap.",
	[Key.placesNotVisited]: "Не посещено",
	[Key.placesUnmarked]: "Не отмечено",
	[Key.placesMorePrefix]: "...и ещё",
	[Key.placesMoreSuffix]: "мест",
	[Key.placesLatestTrip]: "Последняя поездка",
	[Key.placesVisitedProvinces]: "Посещённые провинции",
	[Key.placesMapHint]: "Перетаскивайте для перемещения, прокрутка для масштаба",
	[Key.placesFilterAll]: "Все",
	[Key.placesFilterAllFootprints]: "Все метки",
	[Key.placesSourceTimeline]: "Хронология",
	[Key.placesMapOwnerLocation]: "Местоположение автора",
	[Key.placesMapVisitorLocation]: "Ваше местоположение",
	[Key.placesAreaHighlight]: "Подсветка области",
	[Key.placesClusterDisplay]: "Кластеризация",
	[Key.placesNeedAmapKey]:
		"Настройте amapKey и amapSecurityJsCode в siteConfig.placesMap",
	[Key.placesStatLocationsUnit]: "мест",
	[Key.placesStatVisitsUnit]: "визитов",
	[Key.placesStatThisYearUnit]: "поездок",
	[Key.placesRefresh]: "Обновить обзор",
	[Key.placesFullscreen]: "Полный экран",
